...
class TestWeatherApp(unittest.TestCase):
    ...
    def test_wind_data_class_return(self):
        ...
        self.assertEqual(str(self.test_data_for_wind_data), 'Wind speed: 20.0; wind direction: 90')
    ...
    def test_temperature_data_class_return(self):
        ...
        self.assertEqual(str(self.test_data_for_temperature_data), 'Temperature: 240')

    def test_temperature_in_temperature_data_model(self):
        print("Testing temperature")
        self.assertEqual(self.test_data_for_temperature_data.temperature, '240')

    def test_feels_like_in_temperature_data_model(self):
        print("Testing feels like")
        self.assertEqual(self.test_data_for_temperature_data.feels_like, '260')
    
    def test_temp_max_in_temperature_data_model(self):
        print("Testing feels like")
        self.assertEqual(self.test_data_for_temperature_data.temperature_max, '200')

    def test_temp_min_in_temperature_data_model(self):
        print("Testing feels like")
        self.assertEqual(self.test_data_for_temperature_data.temperature_min, '300')

    def test_other_weather_data_class_return(self):
        print("Testing class return in other weather data")
        self.assertEqual(str(self.test_data_for_other_weather_data), 'Other weather data')

    def test_pressure(self):
        print("Testing pressure")
        self.assertEqual(self.test_data_for_other_weather_data.pressure, '1000')

    def test_humidity(self):
        print("Testing humidity")
        self.assertEqual(self.test_data_for_other_weather_data.humidity, '90')

    def test_visibility(self):
        print("Testing visibility")
        self.assertEqual(self.test_data_for_other_weather_data.visibility, '10000')
    ...
    def test_description(self):
        ...
        self.assertEqual(self.test_data_for_other_weather_data.description, 'broken clouds')

    def test_sunrise(self):
        print("Testing sunrise")
        self.assertEqual(self.test_data_for_other_weather_data.sunrise, '7:00:00')

    def test_sunset(self):
        print("Testing sunset")
        self.assertEqual(self.test_data_for_other_weather_data.sunset, '19:00:00')
